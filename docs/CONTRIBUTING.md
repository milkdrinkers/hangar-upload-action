...
We use Prettier to format our code. When making contributions, make sure to run `pnpm fmt` to format all contents.

Ensure your code follows existing conventions and styling. (*Any issues that arise will be noted in your pull request.*)
